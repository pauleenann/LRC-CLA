...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2025 at 12:15 PM
...
(168, 'n/a', 344, 111, 11, 'public/images/not_found.png');
...
(98, 'TUPM-23-1538', 'Kristine Danielle ', 'Ferrer ', 'Female', '09929927679', 'kristinedanielle.ferrer@tup.edu.ph', 'Student', 2, 10, 'active'),
(99, 'TUPM-24-1038', 'Sophia Luisa', 'Balagtas', 'Female', '09085501761', 'sophialuisa.balagtas@tup.edu.ph', 'Student', 6, 18, 'active'),
(100, 'TUPM-24-1840', 'Kerzlyn', 'Alto', 'Female', '09213499780', 'kerzlyn.alto@tup.edu.ph', 'Student', 6, 18, 'active'),
(101, 'TUPM-23-6928 ', 'Mhitchie ', 'Suico ', 'Female', '09519110630', 'mhitchie.suico@tup.edu.ph', 'Student', 2, 9, 'active'),
(102, 'TUPM-23-6931', 'Ealjean Arielle', 'Velches', 'Female', '09751178746', 'ealjeanarielle.velches@tup.edu.ph', 'Student', 2, 9, 'active'),
(103, 'TUPM-23-9021', 'Joao Ashpyr ', 'Catarungan', 'Male', NULL, 'joaoashpyr.catarungan@tup.edu.ph', 'Student', 2, 9, 'active'),
(104, 'TUPM-23-7088', 'Binn Yazzer', 'Ayunon', 'Male', '09495941708', 'binnyazzer.ayunon@tup.edu.ph', 'Student', 2, 9, 'active'),
(105, 'TUP-24-1551', 'Yujin', 'Cabaysa', 'Female', '09109406693', 'yujin.cabaysa@tup.edu.ph', 'Student', 6, 18, 'active'),
(106, 'TUPM-24-0988', 'Kristine Claire', 'Corpuz', 'Female', '09703690205', 'kristineclaire.corpuz@tup.edu.ph', 'Student', 6, 18, 'active'),
(107, 'TUPM-24-2344', 'Kharla Mae ', 'Celmar ', 'Female', '09455978618', 'kharlamae.celmar@tup.edu.ph', 'Student', 6, 18, 'active'),
(108, 'TUPM-24-1301', 'Angela May', 'Teneros', 'Female', '09201249524', 'angelamay.teneros@tup.edu.ph', 'Student', 6, 18, 'active'),
(109, 'TUPM-24-1811', 'Janehery', 'Bernal', 'Female', '09157998759', 'janeherylei.bernal@tup.edu.ph', 'Student', 6, 18, 'active'),
(110, 'TUPM-24-2384', 'Irish', 'Nabayra', 'Female', '09772306421', 'irish.nabayra@tup.edu.ph', 'Student', 6, 18, 'active'),
(111, 'TUPM-24-0689', 'ANDREA DECELYN', 'SILVA', 'Female', '09381714619', 'andreadecelyn.silva@tup.edu.ph', 'Student', 6, 18, 'active'),
(112, 'TUPM-23-6062', 'Sandy ', 'Gawat', 'Female', '09754980420', 'sandy.gawat@tup.edu.ph', 'Student', 2, 9, 'active'),
(113, 'TUPM-24-4652', 'Eunice Jody ', 'Urbano ', 'Female', '9513459263', 'eunicejody.urbano@tup.edu.ph', 'Student', 6, 18, 'active'),
(114, 'TUPM-24-1818', 'Krizia Mae', 'De Honor ', 'Female', '09122824638', 'kriziamaedehonor@tup.edu.ph', 'Student', 6, 18, 'active'),
(115, 'TUPM-24-2429', 'CHRISTINE MAE', 'Ricafrente', 'Female', '09637743734', 'christinemae.ricafrente@tup.edu.ph', 'Student', 6, 18, 'active'),
(116, 'TUPM-24-0845', 'MARIE ANGELA', 'DEL CASTILLO', 'Female', '09982676384', 'marieangela.delcastillo@tup.edu.ph', 'Student', 6, 18, 'active'),
(117, 'TUPM-24-0869', 'Marie Angelie', 'Del Castillo', 'Female', '09602925476', 'marieangelie.delcastillo@tup.edu.ph', 'Student', 6, 18, 'active'),
(118, 'TUPM-24-1482', 'Nicolyn Jean', 'San Jose ', 'Female', '09064644205', 'nicolynjean.sanjose@tup.edu.ph', 'Student', 6, 18, 'active'),
(119, 'TUPM-24-0749', 'Berna Marie', 'Toñacao', 'Female', '09166095454', 'bernamarie.tonacao@tup.edu.ph', 'Student', 6, 18, 'active'),
(120, 'TUPM-24-12364', 'Jackieline', 'Dantes', 'Female', '09610666484', 'jackieline.dantes@tup.edu.ph', 'Student', 6, 18, 'active'),
(121, 'TUPM-24-2296', 'Alena Joy', 'Torres', 'Female', '09630803975', 'alenajoy.torres@tup.edu.ph', 'Student', 6, 18, 'active');
...
(228, 'Culinart Arts', 'n/a', 'n/a', 1, 0, 0, 4, 1, 1),
(229, 'Food Service and Catering Management: A Practical Guide', 'n/a', '2004', 2, 0, 0, 4, 1, 1),
(230, 'Food Service and Bartending Revised Edition', 'n/a', '2003', 1, 1, 0, 4, 1, 1),
(231, 'Go Kamado', 'An authoritative introduction to the ceramic kamado-style grill, with over 100 recipes for grilling, smoking, and baking, as well as practical guidance on grill use and maintenance. You\'ve got the grill--now get the skills. Learn how to grill, smoke, roast, and bake on the amazing, egg-shaped kamado grill. Backyard entertaining will never be the same once you unlock the potential of this versatile cooker. ', '2018', 1, 0, 0, 4, 1, 1),
(232, 'Philippine Recipes and Other International Recipes', 'n/a', '2012', 1, 1, 0, 4, 1, 1),
(233, 'A Guide to Meal Management and Table Services Revised Edition', 'n/a', '2005', 1, 1, 0, 4, 1, 2),
(234, 'Food Safety, Sanitation and Hygiene', 'n/a', '2010', 2, 2, 0, 4, 1, 1),
(235, 'Western Cuisine', 'n/a', '2014', 1, 1, 0, 4, 1, 1),
(236, 'A Concise Guide in Food & Beverage Service Procedures 2nd Edition', 'n/a', '2015', 2, 2, 0, 4, 1, 1),
(237, 'Technology and Livelihood Education: Cookery', 'n/a', '2015', 1, 1, 0, 4, 1, 1),
(238, 'Principles of Bar Operations', 'n/a', '2007', 1, 1, 0, 4, 1, 1),
(239, 'Introduction to Culinary Arts', 'n/a', '2022', 1, 1, 0, 4, 1, 1),
(240, 'Applied Foodservice Sanitation', 'n/a', '1995', 1, 0, 0, 4, 1, 1),
(241, 'The Dinah Shore American Kitchen', 'n/a', '1990', 1, 1, 0, 4, 1, 1),
(242, 'Asian Cuisine', 'n/a', '2020', 1, 1, 0, 4, 1, 1),
(243, 'Experience Baking', 'n/a', '2020', 1, 1, 0, 4, 1, 1),
(244, 'Bar and Beverage Service', 'n/a', '2022', 2, 2, 0, 4, 1, 1),
(245, 'Kitchen Essentials and Basic Food Preparation', 'n/a', '2021', 2, 2, 0, 4, 1, 1),
(246, 'Modern Food Service Purchasing: A Complete Resource', 'n/a', '2011', 1, 1, 0, 4, 1, 1),
(248, 'A Tracer Study of the BSHRM Program of Technological University of the Philippines for the School Year 2019-2022', 'n/a', '2024', 2, 2, 0, 4, 4, 1),
(249, 'Quick and Easy Sushi Cook Book', 'n/a', '1983', 1, 1, 0, 4, 1, 1),
(321, 'Housekeeping Management', 'Hotels are becoming increasingly conscious of their guests\' high expectations from the housekeeping department. This core textbook gives students on hospitality management courses their first look at the operation of this department.', '2000', 1, 1, 0, 4, 1, 1),
(322, 'Financial Management in the Philippine Setting', 'n/a', '1985', 1, 1, 1, 3, 1, 1),
(323, 'Cost Accounting: Its Nature and Usefulness', 'n/a', '1987', 1, 1, 1, 3, 1, 1),
(324, 'Macro-economics: Concepts, Theories, and Policies (7th Edition)', 'n/a', '1985', 1, 1, 0, 3, 1, 1),
(325, '21st Century Accounting Process: Basic Concepts and Procedures (18th Edition)', 'n/a', 'n/a', 1, 1, 1, 3, 1, 1),
(326, 'A Contemporary Survey of Sentrong Pangkultura ng Biñan: Historicizing its Tangible Heritage', 'n/a', '2018', 1, 1, 0, 6, 4, 1),
(327, 'Supply Chain Management in Hospitality Industry', 'n/a', '2022', 2, 2, 1, 4, 1, 1),
(328, 'Introduction to Meetings, Incentives, Conferences and Events Management (MICE)', 'n/a', '2020', 1, 1, 0, 4, 1, 1),
(329, 'Cost and Materials Management in the Food Service Industry', 'n/a', '2007', 1, 1, 1, 4, 1, 1),
(330, 'Pertinent Laws On Hospitality Management (Tourism Laws)', 'n/a', '2007', 1, 1, 1, 4, 1, 1),
(331, 'Front Office Management and Operations', 'n/a', '1996', 1, 1, 1, 4, 1, 1),
(332, 'Entrepreneurship In Tourism And Hospitality', 'n/a', '2022', 1, 1, 1, 4, 1, 1),
(333, 'Tourism and Hospitality Research', 'n/a', '2021', 1, 1, 1, 4, 1, 1),
(334, 'Introduction to Hotel and Front Office Operations', 'n/a', '2010', 1, 1, 1, 4, 1, 1),
(335, 'Hospitality Supervision Case Scenarios', 'n/a', '2011', 1, 1, 1, 4, 1, 1),
(336, 'Hotel & Motel Management And Operations', 'n/a', '1980', 1, 0, 1, 4, 1, 1),
(337, 'Operations Management in Tourism and Hospitality', 'n/a', '2023', 1, 1, 1, 4, 1, 1),
(338, 'Learn and Practice Good Housekeeping', 'n/a', '2009', 1, 1, 1, 4, 1, 1),
(339, 'Fundamentals in Lodging Operations', 'N/A', '2021', 1, 1, 1, 4, 1, 1),
(340, 'Hotel Housekeeping', 'n/a', '2012', 1, 1, 1, 4, 1, 1),
(341, 'Introduction to Hospitality Management', 'For courses in Introduction to Hospitality and Hospitality Management. Capturing the flavor and breadth of the industry, Introduction to Hospitality Management, Fourth Edition, explores all aspects of the field including: travel and tourism; lodging; foodservice; meetings, conventions and expositions; and leisure and recreation. Devoting six chapters to management, the text focuses on hospitality and management and uses first-person accounts, corporate profiles and industry morsels to foster a student\'s appreciation for the field. Throughout, author John R. Walker invites students to share this industry\'s unique enthusiasm and passion. The text is organized into five sections: the hospitality industry and tourism; lodging; restaurants, managed services, and beverages; recreation, theme parks, clubs, and gaming entertainment; and assemblies and event management.', '2013-07-30', 1, 1, 1, 4, 1, 1),
(344, 'Under our skin', '', '2015', 1, 1, 1, 1, 1, 1);
...
--
ALTER TABLE `audit_log`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=424;
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;

--
-- AUTO_INCREMENT for table `checkin`
--
ALTER TABLE `checkin`
  MODIFY `checkin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

--
-- AUTO_INCREMENT for table `checkout`
--
ALTER TABLE `checkout`
  MODIFY `checkout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `patron`
  MODIFY `patron_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `publisher`
--
ALTER TABLE `publisher`
  MODIFY `pub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `resources`
  MODIFY `resource_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=345;
